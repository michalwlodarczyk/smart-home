...
const sensorUUID = uuid.generate('hap-nodejs:accessories:xiaomi-temperature-sensor');
const sensor = new Accessory('Xiaomi Temperature Sensor', sensorUUID);

sensor.username = "C1:5D:3A:AE:5E:FD";
